  ...
  render() {
    return (
      <div className="widget-demo jimu-widget">
        ...
        <p className="shadow-lg m-3 p-3 bg-white"><FormattedMessage id="latitudeLongitude" defaultMessage={defaultMessages.latitudeLongitude}/>: {this.state.latitude}, {this.state.longitude}</p>
      </div>
    );
  }
}
